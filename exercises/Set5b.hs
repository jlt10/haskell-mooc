...
allValues pred Empty = True
allValues pred (Node a l r) = pred a && allValues pred r && allValues pred l
...
walk (StepL:path) (Node _ l _) = walk path l
walk (StepR:path) (Node _ _ r) = walk path r
